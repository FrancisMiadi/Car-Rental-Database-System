...
public class ContractGUI extends Application {
    ...
    public Scene getContractScene(Stage primaryStage) {
        ...
        ObservableList<String> items = FXCollections.observableArrayList(
                "Contract ID", "Vehicle ID", "Customer Name", "Employee Name", "Cost", "Status", "Start Date", "End Date"
        );
        ...
        ContractTable.getColumns().addAll(
                ...
                employeeNameColumn, costColumn, statusColumn, startDateColumn, endDateColumn
        );
