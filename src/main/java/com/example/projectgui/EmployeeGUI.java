...
public class EmployeeGUI extends Application {
    ...
    public Scene getEmployeeScene(Stage primaryStage) {
        ...
        VBox Menu = new VBox();
        Menu.getChildren().addAll(logoView, space, DASHBOARD, CustomersBtn, current, ContractBtn, PaymentsBtn, MaintenanceBtn, VehiclesBtn, dealBtn);
        Menu.setSpacing(3);
        ...
        ObservableList<String> items = FXCollections.observableArrayList(
                "Employee ID", "First Name", "Last Name", "Salary", "Phone", "Gender", "Role", "Address", "Hire Date"
        );
        ...
        Insert.setOnAction(e -> {
            ...
            ok.setOnAction(e1 -> {
                ...
                Employee newEmployee = new Employee(
                        ...
                        status,
                        "1234" // Default password, should be updated to a more secure mechanism
                );
